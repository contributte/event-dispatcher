![](https://heatbadger.now.sh/github/readme/contributte/event-dispatcher/)
...
The extension automatically discovers all services implementing `Symfony\Component\EventDispatcher\EventSubscriberInterface` and registers them with the event dispatcher.
...
This library provides seamless integration of Symfony's EventDispatcher component into Nette Framework. It enables event-driven architecture in your applications with automatic subscriber discovery, lazy-loading, and debugging tools.
